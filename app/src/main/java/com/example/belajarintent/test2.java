    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.explicitintent:
                Intent explicit = new Intent(test2.this, IntentActivity.class);
                startActivity(explicit);
                break;
            case R.id.explicitintent2:
                Intent explicit2 = new Intent(test2.this, test.class);
                startActivity(explicit2);
                break;
            case R.id.explicitintent3:
                Intent explicit3 = new Intent(test2.this, MainActivity.class);
                startActivity(explicit3);
                break;
            case R.id.explicitintent4:
                Intent explicit4 = new Intent(test2.this, gridlayout2.class);
